    ...
    <?php foreach($juegos as $juego): ?>
        <div class="block">
            <article id="tresbloques">
                <h2><a href="<?=base_url()?>/contenido/<?=$juego["id_publicacion"] ?>"><?=$juego["titulo"] ?></a></h2>
                
                <figure>
                    <a href="<?=base_url()?>/contenido/<?=$juego["id_publicacion"] ?>"><img src="<?=base_url()?>/uploads/<?=$juego["imagen"] ?>"></a>
                    <figcaption>
                       <span>Por <?=$juego["usuario"] ?></span>
                    </figcaption>
                </figure>                       
            </article>
        </div>
