...
<?php if($total > 0){?>
    ...
    <?php foreach($deporte as $deportes): ?>
        <div class="block">
            <article id="tresbloques">
                <h2><a href="<?=base_url()?>/contenido/<?=$deportes["id_publicacion"] ?>"><?=$deportes["titulo"] ?></a></h2>
                
                <figure>
                    <a href="<?=base_url()?>/contenido/<?=$deportes["id_publicacion"] ?>"><img src="<?=base_url()?>/uploads/<?=$deportes["imagen"] ?>"></a>
                    <figcaption>
                       <span>Por <?=$deportes["usuario"] ?></span>
                    </figcaption>
                </figure>                       
            </article>
        </div>
