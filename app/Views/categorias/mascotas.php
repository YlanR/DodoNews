    ...
    <?php foreach($mascotas as $mascota): ?>
        <div class="block">
            <article id="tresbloques">
                <h2><a href="<?=base_url()?>/contenido/<?=$mascota["id_publicacion"] ?>"><?=$mascota["titulo"] ?></a></h2>
                
                <figure>
                    <a href="<?=base_url()?>/contenido/<?=$mascota["id_publicacion"] ?>"><img src="<?=base_url()?>/uploads/<?=$mascota["imagen"] ?>"></a>
                    <figcaption>
                       <span>Por <?=$mascota["usuario"] ?></span>
                    </figcaption>
                </figure>                       
            </article>
        </div>
