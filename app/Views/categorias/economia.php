...
<?php if($total > 0){?>
    ...
    <?php foreach($economia as $economias): ?>
        <div class="block">
            <article id="tresbloques">
                <h2><a href="<?=base_url()?>/contenido/<?=$economias["id_publicacion"] ?>"><?=$economias["titulo"] ?></a></h2>
                
                <figure>
                    <a href="<?=base_url()?>/contenido/<?=$economias["id_publicacion"] ?>"><img src="<?=base_url()?>/uploads/<?=$economias["imagen"] ?>"></a>
                    <figcaption>
                       <span>Por <?=$economias["usuario"] ?></span>
                    </figcaption>
                </figure>                       
            </article>
        </div>
