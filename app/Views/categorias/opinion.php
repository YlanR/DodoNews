    ...
    <?php foreach($opinion as $opinions): ?>
        <div class="block">
            <article id="tresbloques">
                <h2><a href="<?=base_url()?>/contenido/<?=$opinions["id_publicacion"] ?>"><?=$opinions["titulo"] ?></a></h2>
                
                <figure>
                    <a href="<?=base_url()?>/contenido/<?=$opinions["id_publicacion"] ?>"><img src="<?=base_url()?>/uploads/<?=$opinions["imagen"] ?>"></a>
                    <figcaption>
                       <span>Por <?=$opinions["usuario"] ?></span>
                    </figcaption>
                </figure>                       
            </article>
        </div>
